...
public:
	...
	void fit(double *T, const int32_t T_num, selfMatrix::Matrix &R, selfMatrix::Matrix &t, const double indist);
	void fit_nonrigid(double *T, double *Tnormal, const int32_t T_num, selfMatrix::Matrix &R, selfMatrix::Matrix &t, const double indist);
	virtual std::vector<int32_t> getInliers_nonrigid(double *T, double *Tnormal, const int32_t T_num, const selfMatrix::Matrix &R, const selfMatrix::Matrix &t, const double indist)
	{
...
private:
  ...
  // iterative fitting
  void fitIterate(double *T,const int32_t T_num,selfMatrix::Matrix &R,selfMatrix::Matrix &t,const std::vector<int32_t> &active);
  
  // inherited classes need to overwrite these functions
  virtual double               fitStep(double *T,const int32_t T_num,selfMatrix::Matrix &R,selfMatrix::Matrix &t,const std::vector<int32_t> &active) = 0;
  virtual std::vector<int32_t> getInliers(double *T,  const int32_t T_num,const selfMatrix::Matrix &R,const selfMatrix::Matrix &t,const double indist) = 0;
